...
- Compatibility rules & scope guards: [`docs/adr/0017-contract-model-obligations.md`](docs/adr/0017-contract-model-obligations.md) §9
- Broader `assent lint` hard-error list: [`docs/planning/lint-hard-errors.md`](docs/planning/lint-hard-errors.md)
...
replace — the broader hard-error table in [`docs/planning/lint-hard-errors.md`](docs/planning/lint-hard-errors.md).
