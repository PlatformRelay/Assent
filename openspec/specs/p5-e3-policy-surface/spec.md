...
- **REQ-E3-S07-03** — a deprecated rule surfaces its deprecation metadata. Test: `internal/catalogue/catalogue_test.go`; Verify: `go test ./internal/catalogue/... -run TestDeprecationMetadataSurfaced`; Level: L0
